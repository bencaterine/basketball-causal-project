...
def estimate_and_graph(df, type='drafted', img_path='images/ci_matrices2.png', N_bins=4, N_iterations=100,
    interventions=['lane', 'vert'], labels=['Lane Agility Time (s)', 'Standing Vertical Leap (in)']):
